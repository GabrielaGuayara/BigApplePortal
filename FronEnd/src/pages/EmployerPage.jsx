...
const EmployerPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <section className='py-16 px-10 bg-cream'>
        <div className="container mx-auto px-4 text-center">
          <h2 className='text-3xl font-bold text-blue mb-6'>Benefits of Apprenticeships for Employers</h2>
          ...
          <p className='text-xl font-semibold text-gray-800 text-gray mb-12'>Apprenticeship programs help employers:</p>
          
          <div className='flex flex-col md:flex-row justify-center gap-8 w-full items-center'>
           ...
           <benefit.icon className='w-20 h-20 text-blue mb-6' />
           <p className='text-gray-800 text-lg text-center'>{benefit.description}</p>
    </div>
  ))}
</div>
      ...
      <section className='py-16 bg-cerulean'>
        <div className="container mx-auto px-4 text-center">
          <h2 className='text-3xl font-bold text-yellow mb-12'>Hear from Our Employers</h2>
            ...
            {testimonials.map((testimonial, index) => (
              <div key={index} className={`w-9/12 flex flex-col md:flex-row items-center rounded-lg ${index % 2 === 0 ? 'md:flex-row-reverse' : ''} bg-white shadow-xl overflow-hidden`}>
                ...
                <div className="md:w-2/3 p-8 text-left">
                  <Quote className="w-12 h-12 text-blue mb-4" />
                  <p className='text-2xl mb-6 text-gray italic'>{testimonial.quote}</p>
                  <div>
                    <p className='text-lg font-semibold text-gray'>{testimonial.name}</p>
                    <p className='text-gray'>{testimonial.position}</p>
                    <p className='text-gray'>{testimonial.company}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="bg-blue py-16 text-white text-center border-b border-blue">
        <div className="container mx-auto px-4">
          ...
          <Link to="/signup" className="bg-yellow rounded-lg hover:bg-yellow-600 text-blue-900 font-bold py-3 px-8 text-lg transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110">
            Sign Up Now
          </Link>
        </div>
      </section>
